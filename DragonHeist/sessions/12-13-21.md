we open in candle lane, outside of the warehouse with a snake above the doo, where we think the `Zhentarim` are holding `Flune` and `Renaer Neverember`, son of `Dagult Neverember`
