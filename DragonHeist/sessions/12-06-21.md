...
## info
- city watch is cops
- city guard is standing/reserve army
...
- yawning portal, waterdeeps most famous inn, named for large well that goes down into dungeon of undermountain

- zhenterim is run by a group called the doomraiders (ex raiders of lich lairs)
    - headed by `davil starsong`, half-elf bard, who has taken a liking to `Pearson`

- `pearson`, thinking he was cool w/ the zhenterim, tried to connect and realised the schism in the ranks was real. he made enemies with the wrong side, and needs to duck town (a sect of the zhenterim is pretty determined to take over the city)
...
- the wolves have had some infighting, and we battle 

- we made it to the yawning portal...\

# STORY STARTS
- rumors have spread through town that the zhenterim (sp) have been feuding with the zhanathar guild (not legally recognized guild)(criminals)

- young bard three tables over
- there's a 7ft tall half orc that gets hit by a punch from a bald man with eye shaped tatoos on his head

`yagra` is the half orc in the fight, she's a bad bitch

- a fucking monster wit bats (a troll!!)

- we've impressed `durnan`, the barkeep, bad bitch

- figure comes out and smoozhes us
    - he seems pretty cool
    - `Volothemp "volo" Geddarm` chronicler, wizard, and sorceror at your service
        ...
        - friend was kidnapped, or worse
            ...
            - disapeared a couple nights ago
            - we've just got in to town, and we've got literally no money
                - try to pursaude him to increase pay
            - we get 10 gold
            - `flune`, handsom human with wavy red blonde hair, the other night and they were at the `[scewer dragon]`, a tavern `bru` has heard some pretty sketchy stuff about it
...
- `[skewer dragon]` is zhenterim owned
    - `pearson` tells `bru` and `penny` to be cool, honey bunny
    - if `pearson`'s friend, `davil` is there it's all good
    - we're in the trades ward, right next to the dock ward, which is where the `[skewer dragon]` is

- as we travel through the dock ward and turn a corner to find a block quardaned off, by police, ~6 bodies, and 12 officers questioning 3 bloodied people
- we're from the trades ward
- tell and densely packed, very low light in the dock ward, it's sketchy af
- on the corner of something and something is a weird window display, in the window is a stuffed beholder `old xoblob shop`
    - we look around and find:
        - a cloud of lavendar scented purple smoke pours out of shop, everything is fucking purple
        - hairless old gnome on the counter, cheeks decorated by 9 eyes
        - junk
        - purple toy cross bow
        - a floating glass orb that follows you around and makes whiring sounds
        - a dried poison gland of a big fish
        - a blob of purple good, slipery but safe to touch
...
- self deprecating humor gains advantage
    - `pearson` hits up a guy trying to get some info
        ...
        - he remembers, a couple nights ago, someone was gambling with that `volo` character, another friend of `flune`'s showed up, `ranait neverember`, chip off the ol' block (spoiled rich noble who likes to rub our noses in it)
        - they ended up stumbling out of here, got followed by ~5, the zenths, if you're looking for them, there's a wearhouse on candle lane with a snake symbol on the door
        - `neverember`'s are some bougie cunts
- we head to candle lane
    - gloom envolopes, we enter an alley as dark as a dungeon
